...
public class RateLimitConfigurationTests
{
    ...
    [Fact]
    public void RateLimitConfiguration_Returns429StatusCode()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string?>
        {
    ...
    [Fact]
    public void RateLimitConfiguration_EnablesEndpointRateLimiting()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string?>
        {
    ...
    [Fact]
    public void RateLimitConfiguration_DoesNotStackBlockedRequests()
    {
        // Arrange
        var inMemorySettings = new Dictionary<string, string?>
        {
