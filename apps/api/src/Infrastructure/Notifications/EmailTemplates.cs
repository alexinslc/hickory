...
public static class EmailTemplates
{
    private static string WrapInLayout(string title, string bodyContent, string ticketUrl)
    {
        ...
        var sanitizedUrl = SanitizeUrl(ticketUrl);
                                ...
                                <tr>
                                    <td style="padding:32px;">
                                        ...
                                        <div style="margin-top:24px;">
                                            <a href="{sanitizedUrl}" style="display:inline-block; background-color:#1a56db; color:#ffffff; text-decoration:none; padding:10px 24px; border-radius:6px; font-size:14px; font-weight:500;">View Ticket</a>
                                        </div>
                                    </td>
                                </tr>
                                <!-- Footer -->
